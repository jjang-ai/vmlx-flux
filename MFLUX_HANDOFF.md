...
| ideogram (4) | ⬜ scaffold; fp8 mirror staged/scans loadable; direct load validates fp8 sentinel keys; no live generation proof | — | — | `Sources/vMLXFluxModels/Ideogram4/Ideogram4.swift` (native pipeline missing) |
