...
MANIFEST="${ROOT}/OSAURUS_IMAGE_UI_MANIFEST.json"
OPENAPI="${ROOT}/OSAURUS_IMAGE_OPENAPI.json"
...
check(openapi.info?.["x-vmlx-manifest"] === "OSAURUS_IMAGE_UI_MANIFEST.json", "OpenAPI must point to the UI manifest");
